            ...
            <div className="min-h-full flex items-center justify-center py-12 lg:my-10 px-4 sm:px-6 lg:px-8 bg-[#FAF9F6] w-full lg:w-1/2 mx-auto rounded-lg text-gray-900">
                <div className="max-w-md w-full ">
                    ...
                    <div className="signinbutton flex items-center justify-around flex-col lg:flex-row">
                        <button
                            type="button"
                            className="flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none mb-3 lg:mb-0"
                        >
                            <svg
